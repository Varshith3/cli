...
from platform_cli.tools.terraform import enforce_guardrails, terraform_plan, terraform_show_json
...
def register(app: typer.Typer) -> None:
    ...
    @command_meta(
        name="tf-plan",
        category="terraform",
        description="Run terraform plan and enforce local guardrails (Phase 1).",
        tags=["terraform", "plan"],
        config_overrides={
    ...
    def tf_plan(
        ...
        typer.echo("status:         tf-plan completed")
