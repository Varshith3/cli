...
When Codex is working inside this repository, `.ghdp/` is the primary source of truth.
...
- When native Codex-host sub-agent spawning is available, align spawned sub-agents to `.ghdp/agents/<agent-id>.json`.
